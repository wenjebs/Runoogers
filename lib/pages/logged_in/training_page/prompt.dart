    ...
    "weeks": [
      {
        ...
        "daily_schedule": [
          {
            "day_of_week": "$todaysDate",
            "distance_km": 5,
            "type": "Easy run"
          },
          {
            "day_of_week": "$tomorrowsDate",
            "distance_km": 6,
            "type": "Speed work"
          },
          {"day_of_week": "$dayAfterTomorrowsDate", "distance_km": 0, "type": "Rest day"},
...
For weeks 2 and later, make sure to generate ALL DAYS OF THE WEEK and make sure each week has Monday, Tuesday, Wednesday, Thursday, Friday, Saturday and Sunday.
""";
  }
}
