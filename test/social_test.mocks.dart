...
// in runningapp/test/social_test.dart.
...
/// A class which mocks [GetUserPostService].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetUserPostService extends _i1.Mock
    implements _i14.GetUserPostService {
  @override
  _i7.Stream<_i3.QuerySnapshot<Object?>> getPosts(List<String>? friendUids) =>
      (super.noSuchMethod(
        Invocation.method(
          #getPosts,
          [friendUids],
