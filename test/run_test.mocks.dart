...
class MockRepository extends _i1.Mock implements _i7.Repository {
  ...
  @override
  _i8.Future<_i4.UserModel> getUserProfile(String? userId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getUserProfile,
          [userId],
        ),
        returnValue: _i8.Future<_i4.UserModel>.value(_FakeUserModel_3(
          this,
          Invocation.method(
            #getUserProfile,
            [userId],
        ...
        returnValueForMissingStub:
            _i8.Future<_i4.UserModel>.value(_FakeUserModel_3(
          this,
          Invocation.method(
            #getUserProfile,
            [userId],
